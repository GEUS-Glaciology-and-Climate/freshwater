...
echo 'ice'
(cd ${DATADIR}/RACMO/freshwater/runoff_ice_1km; find . -maxdepth 1 -type f -name "*.nc" | LC_ALL=C sort | head -n8 | parallel --keep-order md5sum)
(cd ${DATADIR}/RACMO/freshwater/runoff_ice_1km; find . -maxdepth 1 -type f -name "*.nc" | LC_ALL=C sort | tail -n8 | parallel --keep-order md5sum)
echo 'land_5.5_km'
(cd ${DATADIR}/RACMO/freshwater/runoff_land_5.5km; find . -maxdepth 1 -type f -name "*.nc" | LC_ALL=C sort | head -n8 | parallel --keep-order md5sum)
(cd ${DATADIR}/RACMO/freshwater/runoff_land_5.5km; find . -maxdepth 1 -type f -name "*.nc" | LC_ALL=C sort | tail -n8 | parallel --keep-order md5sum)
echo 'land_1_km'
(cd ${DATADIR}/RACMO/freshwater/runoff_land_1km_regrid; find . -maxdepth 2 -type f -name "*.nc" | LC_ALL=C sort | head -n8 | parallel --keep-order md5sum)
(cd ${DATADIR}/RACMO/freshwater/runoff_land_1km_regrid; find . -maxdepth 2 -type f -name "*.nc" | LC_ALL=C sort | tail -n8 | parallel --keep-order md5sum)
#+END_SRC

#+RESULTS: RACMO_QC_md5sum
| ice                              |                                                                                 |
| b00d1b3a5c42f6dc78c3144c2e90bfa4 | ./runoff.2020_AMJ.BN_RACMO2.3p2_ERA5_3h_FGRN055.1km.DD.nc                       |
| fabb09b9d21cb336f56afc53874be9b6 | ./runoff.2020_JAS.BN_RACMO2.3p2_ERA5_3h_FGRN055.1km.DD.nc                       |
| 4aa15a29c9e7a4efe1a85dda6e61c03f | ./runoff.2020_JFM.BN_RACMO2.3p2_ERA5_3h_FGRN055.1km.DD.nc                       |
| b3551ac17004b87d91f7a0c19d6e02fe | ./runoff.2020_OND.BN_RACMO2.3p2_ERA5_3h_FGRN055.1km.DD.nc                       |
| a4552c9fb6c22fe26d029f9c96ec1f56 | ./runoff.2021_AMJ.BN_RACMO2.3p2_ERA5_3h_FGRN055.1km.DD.nc                       |
| 10e7a6ea8bc0ea7f992a82ec5d4e8697 | ./runoff.2021_JAS.BN_RACMO2.3p2_ERA5_3h_FGRN055.1km.DD.nc                       |
| a1cedf549858058f1b30afc8995282b0 | ./runoff.2021_JFM.BN_RACMO2.3p2_ERA5_3h_FGRN055.1km.DD.nc                       |
| f5cb36ae6e5f76d8b986de27f8f12f2d | ./runoff.2021_OND.BN_RACMO2.3p2_ERA5_3h_FGRN055.1km.DD.nc                       |
| 8c8fb315a533acd89385d44037bcde93 | ./runoff.2023_AMJ.BN_RACMO2.3p2_ERA5_3h_FGRN055.1km.DD.nc                       |
| fe6180f34550c198502555949ad12da4 | ./runoff.2023_JAS.BN_RACMO2.3p2_ERA5_3h_FGRN055.1km.DD.nc                       |
| e90b3a046313c57992600ce39a57ee72 | ./runoff.2023_JFM.BN_RACMO2.3p2_ERA5_3h_FGRN055.1km.DD.nc                       |
| 751a5bbb24b7b3b34239560c6026fab1 | ./runoff.2023_OND.BN_RACMO2.3p2_ERA5_3h_FGRN055.1km.DD.nc                       |
| 9ee04d4e83d2c6f16dbbd58b00bffd1e | ./runoff.2024_AMJ.BN_RACMO2.3p2_ERA5_3h_FGRN055.1km.DD.nc                       |
| 6202537047abc8c8c80866950fe5ee03 | ./runoff.2024_JAS.BN_RACMO2.3p2_ERA5_3h_FGRN055.1km.DD.nc                       |
| 87daec365a1757a5402b67a5759c64b4 | ./runoff.2024_JFM.BN_RACMO2.3p2_ERA5_3h_FGRN055.1km.DD.nc                       |
| 20b347c46b48cb959a7a25a0090f1679 | ./runoff.2024_OND.BN_RACMO2.3p2_ERA5_3h_FGRN055.1km.DD.nc                       |
| land_5.5_km                      |                                                                                 |
...
| ec4a06930113b258a28793a20f7198f2 | ./runoff.2017.FGRN055_BN_RACMO2.3p2_ERA5_3h_FGRN055.DD.nc                       |
| 83c572ee8ee802438d65bcbc06195710 | ./runoff.2018.FGRN055_BN_RACMO2.3p2_ERA5_3h_FGRN055.DD.nc                       |
| b9b0c6254e230162c2c2501f2f0f8762 | ./runoff.2019.FGRN055_BN_RACMO2.3p2_ERA5_3h_FGRN055.DD.nc                       |
| 667456a9101d26a596e3923ee686e0ee | ./runoff.2020.FGRN055_BN_RACMO2.3p2_ERA5_3h_FGRN055.DD.nc                       |
| 7bac4e84d81a127962433af3a03f97a6 | ./runoff.2021.FGRN055.BN_RACMO2.3p2_ERA5_3h_FGRN055.DD.nc                       |
| d92bdfc9ac610c22f39368d253c82ec3 | ./runoff.2022.FGRN055.BN_RACMO2.3p2_ERA5_3h_FGRN055.DD.nc                       |
| 1f35d833464d34cc13c8267c9fc42932 | ./runoff.2023.FGRN055.BN_RACMO2.3p2_ERA5_3h_FGRN055.DD.nc                       |
| 51e5ace65655b5cb1ce4846318edc06b | ./runoff.2024.FGRN055.BN_RACMO2.3p2_ERA5_3h_1940_FGRN055.DD.nc                  |
| land_1_km                        |                                                                                 |
| 22130f323d8e857089c27c767d4c8e8e | ./Tundra_Mask_1km.nc                                                            |
| 97e38a78ea7bb394d63365dde0a3fd3f | ./Weight_files/weights_FGRN055_to_EPSG3413_1km_bilinear.nc                      |
| c66a9484dd7bc180921590c26da3733c | ./out/runoff.2021.FGRN055.BN_RACMO2.3p2_ERA5_3h_FGRN055.DD.nc.1km-bilin.nc      |
| 7245fce87f6cbefef7f1c3fc93f77795 | ./out/runoff.2022.FGRN055.BN_RACMO2.3p2_ERA5_3h_FGRN055.DD.nc.1km-bilin.nc      |
| 30f3ea2808738914969d1ff4658024bc | ./out/runoff.2023.FGRN055.BN_RACMO2.3p2_ERA5_3h_FGRN055.DD.nc.1km-bilin.nc      |
| 622c1b9780ee493aca468e7437fc4714 | ./out/runoff.2024.FGRN055.BN_RACMO2.3p2_ERA5_3h_1940_FGRN055.DD.nc.1km-bilin.nc |
| 22130f323d8e857089c27c767d4c8e8e | ./Tundra_Mask_1km.nc                                                            |
| 97e38a78ea7bb394d63365dde0a3fd3f | ./Weight_files/weights_FGRN055_to_EPSG3413_1km_bilinear.nc                      |
| c66a9484dd7bc180921590c26da3733c | ./out/runoff.2021.FGRN055.BN_RACMO2.3p2_ERA5_3h_FGRN055.DD.nc.1km-bilin.nc      |
| 7245fce87f6cbefef7f1c3fc93f77795 | ./out/runoff.2022.FGRN055.BN_RACMO2.3p2_ERA5_3h_FGRN055.DD.nc.1km-bilin.nc      |
...
README for "Greenland liquid water discharge from 1940 through December 2024"
...
Discharge comes from daily MAR and RACMO RCM runoff, partitioned into each basin, and assigned to each outlet.

The ice dataset report the ice discharge. The land dataset report the the land discharge. The land dataset includes the ID of the upstream ice basins that drain into each land basin, allowing one to find the ice melt discharge at any land outlet.
...
| discharge    | NetCDF files of discharge at each outlet |

In the discharge sub-folders, files are named <RCM>_<YYYY>.nc, where =RCM= is one of "MAR" or "RACMO", and =YYYY= is the year of the data. Within each file are daily discharge values at each outlet.
