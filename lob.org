...
#+RESULTS:
: <ipython-input-331-4f8629f1554b>:88: RuntimeWarning: divide by zero encountered in log10
:   df = np.log10(df)
: <ipython-input-331-4f8629f1554b>:186: UserWarning: This figure includes Axes that are not compatible with tight_layout, so results might be incorrect.
:   plt.savefig("./fig/tukey_daily3.png", bbox_inches='tight', dpi=300)
